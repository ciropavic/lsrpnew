...
export default Vue.extend({
  ...
  data() {
    return {
      ...
      showWindow: false,
      showHideState: false,
      hideState: ChatHideStates.AlwaysShow,
  ...
  methods: {
    ...
    ON_OPEN() {
      ...
      this.focusTimer = window.setInterval(() => {
        if (this.$refs.input) {	
         ...
         if(_iskey == false)
         {
          (this.$refs.input2 as HTMLInputElement).focus();
         }
         else
         {
    ...
    keyUp(e: KeyboardEvent) {
      ...
      if(_iskey == false)
      {
        var end = document.getElementsByTagName('textarea')[1].value.length;
        var endtext = document.getElementsByTagName('textarea')[1].value[end-1]
        if(e.key == '`' || e.key == '~' || e.key == '1' || e.key == '!' || e.key == '2' || e.key == '@' || e.key == '3' || 
            e.key == '#' || e.key == '4' || e.key == '$' || e.key == '5' || e.key == '%' || e.key == '6' || e.key == '^' || 
            e.key == '7' || e.key == '&' || e.key == '8' || e.key == '*' || e.key == '9' || e.key == '(' || e.key == '0' || e.key == ')' || e.key == '_' || e.key == '-' || e.key == '=' || e.key == '+' ||
            e.key == '{' || e.key == '[' || e.key == ']' || e.key == '}' || e.key == '|' || e.key == '\\' ||  e.key == '/' || e.key == '.' || e.key == ',')
        {
        
            document.getElementsByTagName('textarea')[0].value = document.getElementsByTagName('textarea')[0].value + e.key;
  ...
  //  document.getElementsByTagName('textarea')[0].focus();
      var end = document.getElementsByTagName('textarea')[0].value.length;
      var endtext = document.getElementsByTagName('textarea')[0].value[end-1]
      if(e.key == '`' || e.key == '~' || e.key == '1' || e.key == '!' || e.key == '2' || e.key == '@' || e.key == '3' || 
          e.key == '#' || e.key == '4' || e.key == '$' || e.key == '5' || e.key == '%' || e.key == '6' || e.key == '^' || 
          e.key == '7' || e.key == '&' || e.key == '8' || e.key == '*' || e.key == '9' || e.key == '(' || e.key == '0' || e.key == ')' || e.key == '_' || e.key == '-' || e.key == '=' || e.key == '+' ||
          e.key == '{' || e.key == '[' || e.key == ']' || e.key == '}' || e.key == '|' || e.key == '\\' ||  e.key == '/' || e.key == '.' || e.key == ',')
      {
        ...
        if(endtext.match(/[a-z]/i) || endtext == '.' || endtext == ")" || endtext == "." || endtext == "," || endtext == "!" || endtext == "?" || endtext == "1" || endtext == "2" || endtext == "3" || endtext == "4" 
        || endtext == "5" || endtext == "6" || endtext == "7" || endtext == "8" || endtext == "9" || endtext == "0" || endtext == "" || endtext == '/' || endtext == '@' || endtext == '`' || endtext == '~'
        || endtext == '#' || endtext == '$' || endtext == '%' || endtext == '^' || endtext == '&' || endtext == '*' || endtext == '(' || endtext == '-' || endtext == '_' || endtext == '=' || endtext == '+'
        || endtext == '[' || endtext == ']' || endtext == '{' || endtext == '}' || endtext == '\\' || endtext == '|')
        {
        }
        else
        {
      ...
      var currentVar =  document.getElementsByTagName('textarea')[0].value;
      if(e.which == 32)
      {
        ...
        if(currentVar == oldVar)
        {
          ...
          document.getElementsByTagName('textarea')[0].value = currentVar;
          return;
        }
        else
        {
    ...
    keyDown(e: KeyboardEvent) {
      // if(document.getElementsByTagName('textarea')[0].value[0] == 'ㅅ')
      // {
      //   var obj = document.getElementsByTagName('textarea')[0]
      //   obj.value = "";
      //   document.getElementsByTagName('textarea')[0].value = document.getElementsByTagName('textarea')[0].value.substring(1);
      ...
      if (this.message !== "") {
        post(
          ...
          JSON.stringify({
            ...
            message2: document.getElementsByTagName('textarea')[1].value,
    ...
    initialize() {
      ...
      var element1 = document.getElementsByTagName('textarea')[1]
      element1.value = "";
      element.value = "";
      _iskey = false;
    },
