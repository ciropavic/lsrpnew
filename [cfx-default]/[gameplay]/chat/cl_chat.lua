...
Citizen.CreateThread(function()
  ...
  while true do
    ...
    if not chatInputActive then
      if IsControlJustPressed(0, isRDR and `INPUT_MP_TEXT_CHAT_ALL` or 245) --[[ INPUT_MP_TEXT_CHAT_ALL ]] then
    ...
    if chatInputActivating then
      if not IsControlJustPressed(0, isRDR and `INPUT_MP_TEXT_CHAT_ALL` or 245) then
        SetNuiFocus(true)
