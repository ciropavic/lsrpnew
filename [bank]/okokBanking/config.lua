...
Config.IBANPrefix = "LS" -- the prefix of the IBAN

Config.IBANNumbers = 6 -- How many characters the IBAN has by default

Config.CustomIBANMinimumChars = 6

Config.CustomIBANMaxChars = 6 -- How many characters the IBAN can have when changing it to a custom one (on Settings tab)
