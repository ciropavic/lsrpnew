...
Config.PayoutL = 500 --price for lettuce
Config.PayoutP = 500 --price for potatoes
...
Config.Farms = {
	{x= 1857.9, y = 4817.91, z = 44.76, FarmName="Cucumbers", locale = "오이"},
	{x= 1920.75, y = 4754.7, z = 42.56, FarmName="Lettuce", locale = "상추"},
	{x= 1967.93, y = 4867.74, z = 45.5, FarmName="Potatoes", locale = "감자"},
}
